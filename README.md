...
To extract the romFS, Windows users can use [TinkeDSi](https://github.com/R-YaTian/TinkeDSi/releases/latest), but NDSFactory can also be run on macOS and Linux:
